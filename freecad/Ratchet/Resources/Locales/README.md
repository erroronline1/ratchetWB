...
at <https://crowdin.com/project/freecad-addons> webpage and find the **Ratchet** project.

## Creating file for missing locale

### Using script

To create a file for a new language with all **Ratchet** translatable strings execute
...
Also you can rename new `Ratchet.ts` file by appending the locale code,
for example, `Ratchet_de.ts` for German and change
...
Now you can contribute your translated `.ts` file to **Ratchet** repository,
